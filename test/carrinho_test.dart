...
void main() {
  group(
    'Testes de calculo de valor total do carrinho...',
    () {
  ...
  group(
    "G2 - T1- Calculo Valor total de carrinho com imposto 10%",
    () {
      ...
      test(
          '\nDeve retornar o valor original SEM imposto caso seja MENOR que 5.000',
          () {
        // preparação
      ...
      test(
          '\nDeve retornar o valor original COM imposto de +10% caso seja MAIOR que 5.000',
          () {
        // preparação
        final carrinho = Carrinho(items: [
          Item(nome: 'Galaxy J1', preco: 2000),
      ...
      test(
          '\nDeve retornar o valor original COM imposto de +20% caso seja MAIOR que 20.000',
          () {
        // preparação
        final carrinho = Carrinho(items: [
